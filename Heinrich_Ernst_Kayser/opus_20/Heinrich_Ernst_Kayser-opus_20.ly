...
studyXXXIV = \new Voice \relative g'' {
  ...
  \tuplet 3/2 {d8 ees d\!} d'4\flageolet~ |
  %% 21
  d4) \tuplet 3/2 {ees,8_1( f ees} d'4\flageolet-4~\cresc d
  \tuplet 3/2 {e,8_1 f e} d'4\flageolet-4~ |
  %% 22
  d4\!)
  \tupletSpan 2
  \once \override TupletNumber.text = #tuplet-number::calc-fraction-text
  ...
  %% 32
  \tupletSpan 4
  \tuplet 3/2 {d,8( e\< d} a''4\flageolet-4
  ...
  %% 45
  \tuplet 3/2 {d8 c a} fis4 e'-4\flageolet\<~
  \once \override TupletNumber.text = #tuplet-number::calc-fraction-text
...
studyXXVIII = \new Voice \relative g {
  ...
  %% 41
  r8 a,,16\f\downbow( c e a c e-4) a4.\flageolet-4 r8 |
  %% 42
  r a,,16\p\upbow( cis e a cis e-4) a2\flageolet-4~ |
  %% 43
...
studyXXVII = \new Voice \relative c'' {
  ...
  %% 49
  \tuplet 3/2 {
    gis-2\mf( b-4) e\flageolet-. d-.-4 b-.-2 gis-.-4 fis-.\dim e-. d-.} |
  %% 50
  \tuplet 3/2 {cis-.->-2\p b-. a-. gis( a) e-. e'-. dis-. cis-.} |
  %% 51
  ...
  %% 53
  \tuplet 3/2 {e->( gis) b-. e-. gis-. b-.-4} e\flageolet-.-4 r |
  %% 54
  ...
  %% 61
  \tuplet 3/2 {a,-.\mf\downbow cis-. e-. a-. cis-. e-.} a\flageolet\f r |
  %% 62
...
studyXXV = \new Voice \relative c' {
  ...
  %% 24
  gis\cresc( a-4) a( cis) cis( e-4) e( a-4\flageolet) a8\! r r4 |
  %% 25
  ...
  %% 29
  e16\flageolet\f( d-4) d( cis) cis( bes) bes( a) a-3( g) g\dim( f) f( e-4) e( d) |
  %% 30
...
studyXVIII = \new Voice \relative g' {
  ...
  \tuplet 3/2 {c-.\f e\flageolet-.-4 d-.-4 c-. b-. a-.} |
  %% 10
...
#(define fileBaseName "Heinrich_Ernst_Kayser-opus_20")
...
dnl foreach(`Study', StudiesPartII, `EmitMidi(Study)')
